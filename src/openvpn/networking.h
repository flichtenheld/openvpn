 ...
 */
int net_iface_new(openvpn_net_ctx_t *ctx,
 ...
 * @return          0 on success, a negative error code otherwise
 */
int net_addr_v4_add(openvpn_net_ctx_t *ctx,
                    const openvpn_net_iface_t *iface,
...
int net_addr_v6_add(openvpn_net_ctx_t *ctx,
                    const openvpn_net_iface_t *iface,
 ...
 * @return          0 on success, a negative error code otherwise
 */
int net_addr_v4_del(openvpn_net_ctx_t *ctx,
                    const openvpn_net_iface_t *iface,
                    const in_addr_t *addr,
                    int prefixlen);
 ...
 * @return          0 on success, a negative error code otherwise
 */
int net_addr_v6_del(openvpn_net_ctx_t *ctx,
                    const openvpn_net_iface_t *iface,
                    const struct in6_addr *addr,
                    int prefixlen);
 ...
 * @return          0 on success, a negative error code otherwise
 */
int net_route_v4_add(openvpn_net_ctx_t *ctx,
                     const in_addr_t *dst,
                     int prefixlen,
                     const in_addr_t *gw,
                     const openvpn_net_iface_t *iface,
 ...
 * @return          0 on success, a negative error code otherwise
 */
int net_route_v6_add(openvpn_net_ctx_t *ctx,
 ...
 * @return          0 on success, a negative error code otherwise
 */
int net_route_v4_del(openvpn_net_ctx_t *ctx,
                     const in_addr_t *dst,
                     int prefixlen,
                     const in_addr_t *gw,
                     const openvpn_net_iface_t *iface,
 ...
 * @return          0 on success, a negative error code otherwise
 */
int net_route_v6_del(openvpn_net_ctx_t *ctx,
                     const struct in6_addr *dst,
                     int prefixlen,
                     const struct in6_addr *gw,
                     const openvpn_net_iface_t *iface,
 ...
 * @return              0 on success, a negative error code otherwise
 */
int net_route_v4_best_gw(openvpn_net_ctx_t *ctx,
                         const in_addr_t *dst,
                         in_addr_t *best_gw,
 ...
 * @return              0 on success, a negative error code otherwise
 */
int net_route_v6_best_gw(openvpn_net_ctx_t *ctx,
                         const struct in6_addr *dst,
